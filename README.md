...
- Responsive styling using media queries and fluid sizing with clamp()
- Consistent visual design with custom typography and spacing
...
- gallery.html — gallery/catalog page
